...
import 'package:binancy/views/settings/settings_edit_user_info.dart';
...
class _SettingsUserDataViewState extends State<SettingsUserDataView> {
  ...
  Widget myDataCard(BuildContext context) {
    List<Widget> widgetList = [
      ...
      const LinearDivider(),
      SettingsDataRow(
          title: "Tu principio de mes", data: userData['payDay'].toString()),
    ];
          ...
          action: () => showModalBottomSheet(
              ...
              constraints: BoxConstraints(
                  maxHeight: MediaQuery.of(context).size.height -
                      ...
                      kToolbarHeight),
              context: context,
              builder: (context) => const SettingsEditUserInfoView())),
      const LinearDivider(),
      SettingsActionRow(
